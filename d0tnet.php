...
<div class="max-w-6xl mx-auto compact-layout" style="position: relative;">
    <header class="flex flex-row items-center justify-between mb-4 border-b-2 border-gray-500/30 pb-2">
        <div class="flex flex-row items-center space-x-3 mb-0">
            <div class="w-20 h-20 rounded-full overflow-hidden glow-border p-1 bg-black mobile-logo-simple">
            ...
            <div>
                <h1 class="text-2xl md:text-4xl font-bold uppercase tracking-tighter matrix-text">SYSTEM ACCESS</h1>
                <p class="text-sm opacity-80 typing-effect">CONNECTED TO: ANTARCTICA-STATION</p>
            </div>
        </div>
        <div class="text-right">
            <p class="text-lg font-mono" id="digital-clock">00:00:00</p>
            <p class="text-xs">SECURE LINE: <span class="text-red-500">ENCRYPTED</span></p>
        </div>
    </header>

    <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 compact-content mb-0">

        <div class="lg:col-span-1 space-y-3">
            <div class="terminal-window p-3 rounded-lg status-report-card">
                <h2 class="text-xl border-b border-gray-500/50 mb-2 pb-1">STATUS REPORT</h2>
                <ul class="space-y-1 text-xs status-grid">
            ...
            <div class="terminal-window p-3 rounded-lg text-center auth-profile-card">
                <h2 class="text-xl border-b border-gray-500/50 mb-2 pb-1">AUTH PROFILE</h2>
                <div class="w-full h-auto mb-2 overflow-hidden glow-border rounded">
                ...
                <p class="text-lg">AGENT ID: D0TNET</p>
            </div>
        </div>
        <div class="lg:col-span-2 space-y-3">
            <div class="terminal-window p-3 rounded-lg relative overflow-hidden h-full">
                ...
                <div class="bg-black border border-gray-800 rounded-lg overflow-hidden flex items-center justify-center mt-16">
                    <img src="https://raw.githubusercontent.com/d0tnetxx11/zzzz/main/annimasi.gif" alt="Hacker Animation" class="w-150 h-150 object-contain crt-flicker mt-4 mb-4">
                </div>

                <div class="mt-2 p-2 bg-gray-900/20 border border-gray-500/30 rounded mt-9">
    ...
    <div class="terminal-window p-2 rounded-lg font-mono text-xs overflow-hidden mt-5" style="height: 60px;">
        <div id="terminal-log" class="h-full overflow-y-auto terminal-log-container">
...
<script>
    function updateClock() {
        ...
        const antarcticaTime = new Date(utc + (3600000 * 12));
